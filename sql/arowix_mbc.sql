...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2021 at 08:41 AM
...
CREATE TABLE `tournaments` (
  ...
  `kick_off` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `tournament_group_joins`
--

CREATE TABLE `tournament_group_joins` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `group_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `age` int(11) NOT NULL,
...
INSERT INTO `users` (`id`, `avatar`, `fname`, `lname`, `email`, `email_verified_at`, `last_seen`, `password`, `gender`, `phone`, `type`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'dist/images/resources/avatar.png', 'Mao', 'Obinian', 'maolon61@gmail.com', '2021-08-18 21:23:53', '2021-08-19 13:37:30', '$2y$10$Osnab1H5BV6sWUoVJgvMO.p3eMhyfSr1MyFv.tCDbXFb5Q997Eade', 'Male', '09123456789', 2, NULL, '2021-08-18 21:21:20', '2021-08-19 13:37:30'),
(2, 'dist/images/resources/avatar.png', 'Rayan', 'Reynaldo', 'fsdevrayan@gmail.com', '2021-08-19 13:02:04', '2021-08-19 13:36:13', '$2y$10$I9m/LaWX7.9g.SWVOzXFRedEmvvFoV5t5vOPjJ3rQ8I5UC5aTCBu6', 'Male', '09073434113', 2, NULL, '2021-08-19 13:00:45', '2021-08-19 13:36:13');
...
--
-- Indexes for table `tournament_group_joins`
--
ALTER TABLE `tournament_group_joins`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tournament_group_joins`
--
ALTER TABLE `tournament_group_joins`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
